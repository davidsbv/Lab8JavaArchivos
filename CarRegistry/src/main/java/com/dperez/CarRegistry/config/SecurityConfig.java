...
//                        .requestMatchers(HttpMethod.GET, "/users/**", "/login", "/signup").permitAll()
                        .requestMatchers(HttpMethod.POST, "/cars/**", "/brands/**").hasRole("VENDOR")
                        .requestMatchers(HttpMethod.GET, "/cars/**", "/brands/**", "/users/image/**")
                        .hasAnyRole("CLIENT", "VENDOR")
                        .requestMatchers(HttpMethod.POST, "/users/image/**").hasAnyRole("CLIENT", "VENDOR")
